...
public class Assignment1_2 {
	...
	public static int addOctalDigits(int fiveOctalDigitNum){
		...
		int digit1 = fiveOctalDigitNum % 8 ;
		int digit2 = (fiveOctalDigitNum / 8) % 8;
		int digit3 = ((fiveOctalDigitNum / 8) / 8) % 8;
		int digit4 = (((fiveOctalDigitNum / 8) / 8) / 8) % 8;
		int digit5 = ((((fiveOctalDigitNum / 8) / 8) / 8) / 8) % 8;
		int addOctalDigits = digit1 + digit2 + digit3 + digit4 + digit5;
		return addOctalDigits;
	}
